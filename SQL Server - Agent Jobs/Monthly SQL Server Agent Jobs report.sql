...
It will give a summarized picture of SQL Agent jobs run during a calendar month. 
You can use it to file up reports for system audit. 

It does not handle jobs that are run more than once in a day.  
In Next version of the procedure, I will handle that as well.
