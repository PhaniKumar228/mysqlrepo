...
Sample stored procedure that reports real time blocker and waiter SQL statements. This stored procedure, which requires Microsoft SQL Server 2005, lists real time blocks, including the blocked statement and the blocker. 
