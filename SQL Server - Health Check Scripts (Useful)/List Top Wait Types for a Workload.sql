...
Sample stored procedure that lists the top wait types for a workload. See comments for additional information. This stored procedure, contributed by Microsoft's Tom Davidson, requires SQL Server 2005. 
