...
Description
Sample stored procedure that creates an Indexstats table if such a table does not already exist. 
If the Indexstats table already exists, then the table is truncated. 
